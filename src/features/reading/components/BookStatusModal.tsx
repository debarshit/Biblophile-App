...
const styles = StyleSheet.create({
  ...
  switchEditionButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.secondaryDarkGreyHex, paddingHorizontal: SPACING.space_16, paddingVertical: SPACING.space_12, borderRadius: BORDERRADIUS.radius_10, borderWidth: 1, borderColor: COLORS.primaryOrangeHex },
  switchEditionContent: { flex: 1, marginLeft: SPACING.space_12 },
  switchEditionText: { color: COLORS.primaryWhiteHex, fontFamily: FONTFAMILY.poppins_medium, fontSize: FONTSIZE.size_14 },
