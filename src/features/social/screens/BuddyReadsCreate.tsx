...
const BuddyReadsCreate = ({ route }: any) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Make a request to the backend to create a new Buddy Read
      const response = await instance.post(requests.createBuddyRead, buddyReadData, {
        headers: {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollViewContainer} contentContainerStyle={styles.contentContainer}>
        ...
        <Text style={styles.hint}>
          Optional. Set an end date. If left blank, it ends when all mark as read.
        </Text>

        {/* Max Members */}
        <Text style={styles.label}>Max Members (1 - 15)</Text>
        <TextInput
          style={styles.input}
        ...
        />
        <Text style={styles.hint}>
          Set a maximum number of members. Between 1 and 15.
        </Text>

        {/* Public Toggle */}
        <Text style={styles.label}>Make Buddy Read Public?</Text>
        ...
        <Text style={styles.hint}>
          A public buddy read is discoverable and anyone can join.
        </Text>

        {/* Buttons */}
        <View style={styles.buttonRow}>
          <TouchableOpacity style={styles.submitButton} onPress={handleSubmit}>
            <Text style={styles.submitText}>Create Buddy Read</Text>
          </TouchableOpacity>
...
export default BuddyReadsCreate;
